...
public final class AccountLevelStatusCodeMapper implements RowMapper<AccountLevelStatusCode> {


    @Override
    public AccountLevelStatusCode mapRow(final ResultSet resultSet, final int rowNum) throws SQLException {

        return AccountLevelStatusCode.builder()
                .ACCT_NO(resultSet.getString("ACCT_NO"))
